<template lang="pug">
  <button class="button" v-bind:class="modsToClass">{{title}}</button>
</template>
<script>
export default {
  computed: {
...
.button {
  ...
  &_main-color {
    ...
    &:hover,
    &:active {
      background-color: $hover-button-main-color;
    }
  }
  ...
  &_secondary-color {
    ...
    &:hover,
    &:active {
      background-color: $hover-button-secondary-color;
      color: $hover-button-secondary-font-color;
    }
  }
}
</style>
