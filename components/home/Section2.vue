<template lang="pug">
    section.section2
      .section2__slogan
        h2.section2__header Бесплатный подбор квартиры в один клик
        article.section2__article 
          | Отсейте все неподходящие варианты одним махом 
...
.section2 {
  ...
  &__image {
    ...
    min-width: 460px;
    min-height: 546px;
    background-image: url('~assets/home/section2/phone.png');
    position: relative;
    left: -10.67%;
    top: -15.15%;
    // bottom: -50.3%;
