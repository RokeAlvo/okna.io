/* eslint-disable camelcase */ /* eslint-disable no-unused-vars */
<template>
  <transition name="fade">
    <div class="overlow-loader">
      <div class="canvas-wrapper">
        <canvas id="canvasOne" width="520" height="520"></canvas>
      </div>
    </div>
  </transition>
</template>
...
export default {
  mounted() {
    ...
    function canvasApp() {
      ...
      if (!theCanvas) return
      // if(1) {
      //   theCanvas.setAttribute('width', 900);
      //   theCanvas.setAttribute('height', 900);
      // }
